...
export const SIDEBAR_INTRO = (): TSidebarItem[] => [
    {
        label: localize('Welcome to BrianDev AI Nexus Pro!'),
        content: [
            {
                data: localize(
    ...
    },
    {
        ...
        content: [{ data: localize('BrianDev AI Nexus Pro - your automated trading partner') }],
        link: true,
    },
    {
        label: localize('FAQs'),
        content: [
            {
                data: localize('What is BrianDev AI Nexus Pro?'),
                faq_id: 'faq-0',
            },
            {
