...
const PWAInstallModal: React.FC = () => {
    ...
    const getInstallSteps = () => {
        if (isDesktop) {
            return [
                ...
                localize('Follow the prompts to install BrianDev AI Nexus Pro.'),
            ];
        } else if (isIOS) {
            return [
                localize('Open BrianDev AI Nexus Pro in your browser.'),
        ...
        <div className='pwa-install-modal__content'>
            <div className='pwa-install-modal__description'>
                <Text size='xs' color='prominent'>
                    {isPWALaunch
                        ? localize("Welcome to BrianDev AI Nexus Pro! You're using the mobile app version.")
                        : isDesktop
                          ? localize('Install BrianDev AI Nexus Pro as a desktop app for faster access and a native experience!')
                          : localize(
                                "We're excited to announce that BrianDev AI Nexus Pro is now a Progressive Web App (PWA)!"
                            )}
                </Text>
            </div>
    ...
    const modalContent = isMobile ? (
        <MobileFullPageModal
            ...
            page_header_text={localize('Install BrianDev AI Nexus Pro')}
        ...
        <Modal
            ...
            title={isDesktop ? localize('Install BrianDev AI Nexus Pro') : localize('Introducing our installable app')}
            has_close_icon={true}
